ZYNEXTOOLS — VERSION 1.4.0

INSTALL
1. Extract this ZIP (zynextools-extension.zip) to a permanent folder.
2. Open chrome://extensions or edge://extensions.
3. Enable Developer mode.
4. Click Load unpacked.
5. Select the folder containing manifest.json.
6. Open the extension and sign in with your ZynexTools account.
7. If you already had an older version loaded, remove it and load this folder again (or click Reload on chrome://extensions).

WHAT'S NEW (1.4)
- Rebranded to ZynexTools (name + icons).
...
- If the panel only accepts signed tokens from the seller login, admin must paste
...
Use the ZynexTools Android app, or desktop Chrome / Microsoft Edge.
