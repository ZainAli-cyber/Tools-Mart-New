...
export const ToolPage: React.FC<ToolPageProps> = ({
  ...
  const [metaAuthor, setMetaAuthor] = useState<string>('AI TOOLZ MART');
  ...
  // Generator Options
  const [qrContent, setQrContent] = useState<string>('https://aitoolzmart.com');
    ...
    try {
      switch (tool.id) {
        ...
        case 'meta-tag-generator': {
          const generatedCode = `<!-- Generated by AI TOOLZ MART -->
...
<meta name="twitter:card" content="summary_large_image">`;
        ...
        case 'schema-markup-generator': {
          const detailsObj = {
            ...
            url: inputUrl || 'https://aitoolzmart.com',
          };
        ...
        case 'robots-txt-generator': {
          const robotsCode = `# Robots.txt generated by AI TOOLZ MART
User-agent: *
Disallow: /admin/
Disallow: /private/
Disallow: /wp-admin/
...
Sitemap: ${inputUrl || 'https://aitoolzmart.com'}/sitemap.xml`;
        ...
        case 'xml-sitemap-generator': {
          const domain = inputUrl || 'https://aitoolzmart.com';
  ...
  <url>
    ...
    <priority>0.80</priority>
        ...
        case 'qr-code-generator': {
          setResultOutput({ qrContent: qrContent || 'https://aitoolzmart.com' });
          break;
        }
