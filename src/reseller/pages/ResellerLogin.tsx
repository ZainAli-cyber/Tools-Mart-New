    ...
    <div className="min-h-screen bg-[#0a0808] flex items-center justify-center px-4 relative"
      ...
      <div className="w-full max-w-md">
        <div className="bg-[#130d0d]/90 border border-[#3a2a26] rounded-3xl p-8 shadow-2xl"
          ...
          <form onSubmit={submit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" value={email} onChange={e => setEmail(e.target.value)} required placeholder="reseller@example.com"
          ...
          <p className="text-center text-xs text-slate-600 mt-6">Reseller area · Unauthorized access prohibited</p>
        </div>
      </div>
    </div>
  );
